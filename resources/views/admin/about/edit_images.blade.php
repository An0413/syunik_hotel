        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-12 col-lg-12 col-md-12">
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <form action="{{ route('about_images_update', $about_images->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="title_am" value="{{$about_images->title_am}}">
                        </div>
                        <div class="mb-3">
                            <label for="title_ru" class="form-label">Անուն ռուսերեն</label>
                            <input class="form-control" type="text" name="title_ru" value="{{$about_images->title_ru}}">
                        </div>
                        <div class="mb-3">
                            <label for="title_en" class="form-label">Անուն անգլերեն</label>
                            <input class="form-control" type="text" name="title_en" value="{{$about_images->title_en}}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <img src="{{asset('images/about/'.$about_images->image)}}" class="show_img" id="img">
                        </div>
